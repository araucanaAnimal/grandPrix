...
<section id="section1" class="ct-u-backgroundDarkGray contenido">
   <div class="row ct-u-paddingTop70 fullpage-info">
        ...
        <div class="tab-content ct-navTabs-content--dark">
            <div class="tab-pane active fade in inside" id="misdatos7">
               <div class="col-md-12 escuderia">
                ...
                <div class="col-md-5">
                	<img src="assets/images/sucursales/<?php echo $info[$_SESSION["sucursal"]]['i'];?>" alt="">
                    </div>
                    <div class="col-md-7">


    <div class="progress">
        <div class="progress-bar progress-bar-warning  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil((($info[$_SESSION["sucursal"]]['_vnn']+$info[$_SESSION["sucursal"]]['_vnr'])/(($info[$_SESSION["sucursal"]]['_maxVnn']+$info[$_SESSION["sucursal"]]['_maxVnr'])))*100);?>" aria-valuemin="0" aria-valuemax="100">
    ...
    <div class="progress mini-progress">
        <div class="progress-bar progress-bar-warning  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_vnn']/($info[$_SESSION["sucursal"]]['_maxVnn']))*100);?>" aria-valuemin="0" aria-valuemax="100">
    ...
    <div class="progress mini-progress">
        <div class="progress-bar progress-bar-warning  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_vnr']/($info[$_SESSION["sucursal"]]['_maxVnr']))*100);?>" aria-valuemin="0" aria-valuemax="100">
   ...
   <div class="progress mini-progress">
    ...
    <div class="progress mini-progress">
        ...
        aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_sv']/($info[$_SESSION["sucursal"]]['_maxSi']))*100);?>" aria-valuemin="0" aria-valuemax="100">
            <span class="ct-progressBar-text">Seguros Individuales &nbsp<?php echo $info[$_SESSION["sucursal"]]['_sv']."/".$info[$_SESSION["sucursal"]]['_maxSi'];?></span>
            <div class="ct-progressBar-tr"></div>
        </div>
    </div>
    <div class="progress mini-progress">
...
<table class="table table-striped">
	...
	<div class="col-md-6">
		<img src="assets/images/<?php echo $info[$_SESSION['sucursal']]['tipsImage'];?>" class="img-responsive" alt="Consejos en los pits">
                ...
                <div class="col-lg-12">
               	<div class="col-lg-8">
               		<img class="img-responsive" src="assets/images/pos3.jpg" style="max-width: 100%" />
               	</div>
            	...
            	<div class="col-md-12">
 		 		...
 		 		<div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody><?php
                        $pos = 1;$lp = NULL;$tp = 1;
                        foreach($ranking_final['warning'] as $_k=>$_v){
