   ...
   <div class="row ct-u-paddingTop70 fullpage-info">
    <div class="menu-left">
        <ul class="nav nav-tabs ct-navTabs--dark nav-stacked diagonal" role="tablist" id="myTab7">
            ...
            <li class="ct-navTabs--default"><a href="#bases7" role="tab" data-toggle="tab">Bases</a></li>
        </ul>
    </div>
    <div class="container">
               ...
               <div class="col-md-12 escuderia">
                ...
                <div class="col-md-7 pad-top-50">
                    ...
                    <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar"
                        ...
                        <span class="ct-progressBar-text">Ventas <?php echo /*$p*/ $info[$_SESSION["sucursal"]]['vl']."/".$info[$_SESSION["sucursal"]]['vt'];?></span>
        <!-- ajustar datos según excel - aria-valuenow define el valor, span lo muestra sobre la barra de colores-->
                        <div class="ct-progressBar-tr"></div>
                    </div>
                </div>
                <div class="progress">
                    <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar"
                         aria-valuenow="<?php echo $re;?>" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar"
                         aria-valuenow="<?php echo $ri;?>" aria-valuemin="0" aria-valuemax="100">
                        <span class="ct-progressBar-text">Riesgo <?php echo /*$ri*/ $info[$_SESSION["sucursal"]]['ril']."/".$info[$_SESSION["sucursal"]]['rit'];?></span>
        ...
        ?>
            ...
            <div class="tab-pane fade" id="posicion7">
               <div class="col-md-12 mar-bot-20">
                ...
                <img src="assets/images/m1.jpg" style="max-width: 100%" />
            </div>
            ...
            <div class="tab-pane fade" id="bases7">
