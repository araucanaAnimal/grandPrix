...
define('COLOR','rojo');
$pos_g = array();
$lp = 0;$tp = 1;$p = 1;$rf = $ranking_final[COLOR];$n=1;
foreach($rf as $_k=>$_v){
if($_v != $lp){
$p = $tp;
}
...
<div class="progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['vl']/$info[$_SESSION["sucursal"]]['vt'])*100);?>" aria-valuemin="0" aria-valuemax="100">
...
<div class="progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['ril']/$info[$_SESSION["sucursal"]]['rit'])*100);?>" aria-valuemin="0" aria-valuemax="100">
...
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_r']/10)*100);?>" aria-valuemin="0" aria-valuemax="100">
<span class="ct-progressBar-text">Reprogramaciones <?php echo $info[$_SESSION["sucursal"]]['_r']."/10";?></span>
<div class="ct-progressBar-tr"></div>
</div>
</div>
<div class="progress mini-progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_cc']/10)*100);?>" aria-valuemin="0" aria-valuemax="100">
<span class="ct-progressBar-text">Cruce Cesantía <?php echo $info[$_SESSION["sucursal"]]['_cc']."/10";?></span>
<div class="ct-progressBar-tr"></div>
</div>
</div>
<div class="progress mini-progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_cv']/25)*100);?>" aria-valuemin="0" aria-valuemax="100">
<span class="ct-progressBar-text">Calidad de Venta <?php echo $info[$_SESSION["sucursal"]]['_cv']."/25";?></span>
<div class="ct-progressBar-tr"></div>
</div>
</div>
<div class="progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['rel']/$info[$_SESSION["sucursal"]]['ret'])*100);?>" aria-valuemin="0" aria-valuemax="100">
<span class="ct-progressBar-text">Rentabilidad <?php echo /*$re*/ $info[$_SESSION["sucursal"]]['rel']."/".$info[$_SESSION["sucursal"]]['ret'];?></span>
<div class="ct-progressBar-tr"></div>
</div>
</div>
<div class="progress mini-progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_sv']/5)*100);?>" aria-valuemin="0" aria-valuemax="100">
<span class="ct-progressBar-text">Seguros Voluntarios <?php echo $info[$_SESSION["sucursal"]]['_sv']."/5";?></span>
<div class="ct-progressBar-tr"></div>
</div>
</div>
<div class="progress mini-progress">
<div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar"aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_mp']/10)*100);?>" aria-valuemin="0" aria-valuemax="100">
...
<td>'.$info[$pos[$i]]["p"].'</td>
	...
	<div class="col-md-6">
		<img src="assets/images/pits_adv.png" class="img-responsive" alt="Consejos en los pits">
                ...
                <div class="col-lg-12">
               	<div class="col-lg-8">
               		<img class="img-responsive" src="assets/images/pos4.jpg" style="max-width: 100%" />
               	</div>
