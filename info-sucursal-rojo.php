        ...
        <div class="tab-content ct-navTabs-content--dark">
            <div class="tab-pane active fade in inside" id="misdatos7">
               <div class="col-md-12 escuderia">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-danger  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil((($info[$_SESSION["sucursal"]]['_vnn']+$info[$_SESSION["sucursal"]]['_vnr'])/(($info[$_SESSION["sucursal"]]['_maxVnn']+$info[$_SESSION["sucursal"]]['_maxVnr'])))*100);?>" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="progress mini-progress">
                    <div class="progress-bar progress-bar-danger  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_vnn']/($info[$_SESSION["sucursal"]]['_maxVnn']))*100);?>" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="progress mini-progress">
                    <div class="progress-bar progress-bar-danger  progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo ceil(($info[$_SESSION["sucursal"]]['_vnr']/($info[$_SESSION["sucursal"]]['_maxVnr']))*100);?>" aria-valuemin="0" aria-valuemax="100">
            	...
            	<div class="col-md-12">
 		 		...
 		 		<div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody><?php
                        $pos = 1;$lp = NULL;$tp = 1;
                        foreach($ranking_final['danger'] as $_k=>$_v){
